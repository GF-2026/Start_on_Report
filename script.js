...
resistance_ls_rs: get('resistance_hs_rs'),
resistance_ls_rt: get('resistance_hs_rt'),
resistance_ls_st: get('resistance_hs_st'),
resistance_ls_to_ground: get('resistance_hs_to_ground'),
current_ls_t: get('current_ls_t'),
customer_suggestions: get('customer_suggestions'),
